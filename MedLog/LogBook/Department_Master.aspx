<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MedMaster.Master" CodeBehind="Department_Master.aspx.cs" Inherits="LogBook.UI.Department_Master" %>
       ...
       <ContentTemplate>
        ...
        <div id ="pnlPop" runat="server"  class="modalPopup"  
            ...
            <table class="style1">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label3" Font-Size="12px"  runat="server" Text="Department Name"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtDeptName" runat="server" Width="250px" Height="22px"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="txtDeptName" ErrorMessage="*" ValidationGroup="save"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" runat="server" Height="28px" onclick="btnSave_Click" 
                            Text="Save" Width="75px" ValidationGroup="save" />
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
               ...
               <tr>
                   ...
                   <td align="right">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="glassy_btn" 
                           Height="22px">Add New Department</asp:HyperLink>
                      <%-- <asp:ImageButton ID="ImageButton2" runat="server" CssClass="fb5" 
                           ImageUrl="~/images/icons/add.gif" onclick="ImageButton2_Click" />--%>
                   </td>
               </tr>
               <tr>
                   <td colspan="2">
                       <asp:GridView ID="gvDept" runat="server" AllowPaging="True" CellPadding="3" 
...
<asp:Label ID="Label2221" CssClass="style301" runat="server" Font-Bold="False" 
        Text="&amp;nbsp; Department Master.."></asp:Label>
