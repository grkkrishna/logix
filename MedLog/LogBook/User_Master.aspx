<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MedMaster.Master" CodeBehind="User_Master.aspx.cs" Inherits="LogBook.UI.User_Master" %>
       ...
       <ContentTemplate>
        ...
        <div id ="pnlPop" runat="server"  class="modalPopup"  
            ...
            <table class="style1">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label3" Font-Size="12px"  runat="server" Text="UserName"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtUserName" runat="server" Width="250px" Height="22px" ontextchanged="txtUserName_TextChanged" 
                           ></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="txtUserName" ErrorMessage="*" ValidationGroup="save"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                 <tr>
                    <td class="style302">
                        <asp:Label ID="Label4" Font-Size="12px"  runat="server" Text="Password"></asp:Label>
                    </td>
                    <td class="style302">
                        <asp:TextBox ID="txtPassword" runat="server" Width="250px" Height="22px" 
                           ></asp:TextBox>
                    </td>
                    <td class="style302">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ErrorMessage="*" ValidationGroup="save" ControlToValidate="txtPassword"></asp:RequiredFieldValidator>
                        </td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" Font-Size="12px"  runat="server" Text="UserType"></asp:Label>
                    </td>
                    <td>
           ...
           <table class="style1">
               <tr>
                   <td align="left">
                       ...
                       <asp:DropDownList ID="ddlSearUsertype" runat="server" CssClass="ddl">
                       <asp:ListItem Value="0">--SelectUsertype--</asp:ListItem>
                           <asp:ListItem Value="1">Admin</asp:ListItem>
                           <asp:ListItem Value="2">User</asp:ListItem>
                       </asp:DropDownList>
                   ...
                   <td align="right">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="glassy_btn" 
                           Height="22px">Add New User</asp:HyperLink>
               ...
               <tr>
                   <td colspan="2">
                       <asp:GridView ID="gvUser" runat="server" AllowPaging="True" CellPadding="3" 
